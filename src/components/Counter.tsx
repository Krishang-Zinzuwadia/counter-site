  ...
  const renderTimeBlock = (valueString: string, label: string) => {
    ...
    return (
      <div className="flex flex-col items-center gap-1.5">
            ...
            <div
              ...
              className={`relative overflow-hidden flex items-center justify-center bg-white/10 backdrop-blur-md border rounded-2xl transition-all duration-300 w-11 h-16 sm:w-18 sm:h-26 md:w-20 md:h-28 shadow-lg ${
                isWarning
                  ...
                  : isFinished
                  ? "border-amber-500/30 text-amber-500/70 shadow-none animate-none"
        ...
        <span className="text-[9px] sm:text-xs font-bold tracking-widest text-white/50 uppercase">
          {label}
        </span>
      </div>
    );
    ...
    <div className="flex flex-col items-center gap-8 w-full max-w-2xl px-2">
      <div className="flex flex-col items-center gap-6 w-full">
        ...
        <div className="flex items-center justify-center gap-1 sm:gap-2">
          ...
          <div className="text-white/40 text-2xl sm:text-4xl md:text-5xl font-extrabold pb-5 sm:pb-6 animate-pulse select-none">:</div>
